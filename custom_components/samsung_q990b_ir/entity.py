"""Base entity for Samsung HW-Q990B IR integration."""
...
from .ir_codes import Q990BCode, Q990BCommand

_LOGGER = logging.getLogger(__name__)


class Q990BIrEntity(Entity):
    """Samsung HW-Q990B IR base entity."""
    ...
    async def _send_command(self, code: Q990BCode) -> None:
        """Send an IR command through the selected emitter."""
        if not code.value:
            _LOGGER.warning("IR code for %s not learned yet", code.name)
            return
